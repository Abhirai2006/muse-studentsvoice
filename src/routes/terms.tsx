  ...
  head: () => ({
    meta: [
      { title: "Terms of Use — MUSE Students Voice" },
      {
        name: "description",
        content:
          "Acceptable-use rules for MUSE Students Voice: who can post, what is not allowed, how moderation works, and what is not guaranteed.",
      },
      { property: "og:title", content: "Terms of Use — MUSE Students Voice" },
      {
        property: "og:description",
        content:
          "House rules for MUSE Students Voice: posting limits, prohibited content, moderation, and admin escalation policy.",
      },
  ...
  return (
    <SiteShell>
      <article className="prose prose-sm dark:prose-invert max-w-none">
        ...
        <p className="text-sm">
          MUSE Students Voice is open to students of{" "}
          <strong>Mysore University School of Engineering (MUSE)</strong> whose USN is on the
          registry. One account per USN.
        </p>
        ...
        <p className="text-sm">
          Posts and comments may be removed by the platform administrator if they violate these
          rules, regardless of how the community has voted. Repeated violations may result in the
          associated account being suspended and its USN released back to the registry.
        </p>

        <h2 className="mt-6 text-base font-semibold">No guarantees</h2>
        <p className="text-sm">
          Students Voice is provided as-is by a student maintainer. We make no guarantee that
          complaints will be acted upon by the college.
        </p>
      </article>
    </SiteShell>
  );
